    ...
    **kwargs,
    ...
    for module in trainer.model.modules():
        if hasattr(module, 'benchmarking'):
            module.benchmarking = False # TODO check
    ...
    os.makedirs(f'./saves/tests/k_acc_bucket/{trainer.checkpoint_path}/', exist_ok=True)
    torch.save({'k_acc_bucket':k_acc_bucket}, f'./saves/tests/k_acc_bucket/{trainer.checkpoint_path}/k_{trained_k}.pth')
