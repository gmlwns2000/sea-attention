...
if kwargs['perlin_colsel']:
    ...
    if colsel_perform_cnt>0:
        per_item_col_real_1_for2 = bench.get_temp_buffer('per_item_col_real_1_for2', index_layer)
        col_t_alive_mask_bef_inter_1_for2 = bench.get_temp_buffer('col_t_alive_mask_bef_inter_1_for2', index_layer)
        col_t_alive_mask_t_1_for2 = bench.get_temp_buffer('col_t_alive_mask_t_1_for2', index_layer)
        col_t_alive_mask_m_1_for2 = bench.get_temp_buffer('col_t_alive_mask_m_1_for2', index_layer)
        per_item_condition_not_satisfied_1_for2 = bench.get_temp_buffer('per_item_condition_not_satisfied_1_for2', index_layer)
        ...
        per_item_col_real_2 = bench.get_temp_buffer('per_item_col_real_2', index_layer)
        col_t_alive_mask_bef_inter_2 = bench.get_temp_buffer('col_t_alive_mask_bef_inter_2', index_layer)
        col_t_alive_mask_t_2 = bench.get_temp_buffer('col_t_alive_mask_t_2', index_layer)
        col_t_alive_mask_m_2 = bench.get_temp_buffer('col_t_alive_mask_m_2', index_layer)
        per_item_condition_not_satisfied_2 = bench.get_temp_buffer('per_item_condition_not_satisfied_2', index_layer)
        per_t_in_item_top_k_for2 = bench.get_temp_buffer('per_t_in_item_top_k_for2', index_layer)
