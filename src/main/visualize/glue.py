...
def main(
    ...
    **kwargs
    ...
    # torch.save({'estimated_attn':attentions[1]['estimated_attn'], 'dense_attn': attentions[1]['dense_attn'], 'token_length': batch['attention_mask'][7].sum().item()}, './debug/bert_viz.pth') # layer1
    # breakpoint()
